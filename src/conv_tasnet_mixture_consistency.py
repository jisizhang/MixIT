# -*- coding: utf-8 -*-
"""
Created on Thu Dec 17 14:39:17 2020

Conv-TasNet + Mixture consistency
...
class ConvTasNet(nn.Module):
    ...
    def forward(self, mixture):
        ...
        # Mixture Consistency in mixture of mixtures
        est_mixture = torch.sum(est_source, dim=1, keepdim=True) # [M, 1, T]
        bias_mixture = (torch.unsqueeze(mixture, 1) - est_mixture) / self.C # [M, 1, T]
        est_source = est_source + bias_mixture
        return est_source
